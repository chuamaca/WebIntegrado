        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-custom-purple">
            ...
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                <li class="nav-item active">
                    <a class="nav-link" href="pagEspecial.jsp"><i class="fas fa-home"></i>Especialidad<span class="sr-only">(current)</span></a>
                </li>
                ...
                <li>
                    <a class="nav-link" href="./control?opc=4">crud de Alumnos</a>
                </li> 
