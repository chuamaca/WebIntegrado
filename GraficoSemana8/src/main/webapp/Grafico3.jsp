...
<%@page import="Model.MVentasArticulo, Data.Dventas"%>
<html>
    <head>
        <script src=
    ...
    <body>
                            ...
                            <form action="" method="pos">
                                ...
                                <table class="table table-bordered">
                                    <tr><th>Mes<th>Monto
                                            ...
                                            <%
                                                for (MVentasArticulo ventas : listaventas.SelectVentasArticulo(anio)) {
                                                    out.println("<tr><td>" + ventas.getArt_nom() + "<td>" + ventas.getArt_can());
                                                }
                                            %>
                                    </tr>
                                </table>
        ...
        <%System.out.println("anio" + anio);
            ...
            for (MVentasArticulo ventas : listaventas.SelectVentasArticulo(anio)) {
                ...
                label = label + "'" + ventas.getArt_nom() + "',";
                data = data + ventas.getArt_can() + ",";
