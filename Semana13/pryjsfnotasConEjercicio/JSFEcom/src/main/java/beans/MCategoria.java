...
public class MCategoria implements Serializable {
    ...
    public MCategoria(Integer IdCategoria, String Nombre, String Descripcion, int Estado, int UsuarioCrea, Date FechaCrea, int UsuarioModifica, Date FechaModifica, int UsuarioElimina, Date FechaElimina, double total) {
        this.IdCategoria = IdCategoria;
        this.Nombre = Nombre;
